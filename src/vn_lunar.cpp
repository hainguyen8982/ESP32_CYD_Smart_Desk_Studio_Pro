...
static uint32_t lunar_dd = 1;
static uint32_t lunar_mm = 1;
static uint32_t lunar_yy = 2026;
...
uint32_t vn_lunar::get_lunar_dd() { return lunar_dd; }
uint32_t vn_lunar::get_lunar_mm() { return lunar_mm; }
uint32_t vn_lunar::get_lunar_yy() { return lunar_yy; }
