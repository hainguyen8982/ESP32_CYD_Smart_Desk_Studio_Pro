...
void NetworkManager::setupWebRoutes() {
    ...
    server.on("/", HTTP_GET, [this](AsyncWebServerRequest *request) {
        String html = "<!DOCTYPE html><html lang='vi'><head><meta charset='UTF-8'>"
                      ...
                      "<div style='margin-bottom:8px'><label>Ngoại tệ 1:</label><select class='select-box' id='cur1'><option value='USD'>USD - Đô la Mỹ</option><option value='EUR'>EUR - Euro</option><option value='JPY'>JPY - Yên Nhật</option><option value='GBP'>GBP - Bảng Anh</option><option value='AUD'>AUD - Đô la Úc</option><option value='SGD'>SGD - Đô la Singapore</option><option value='CNY'>CNY - Nhân dân tệ</option><option value='KRW'>KRW - Won Hàn Quốc</option><option value='CAD'>CAD - Đô la Canada</option><option value='CHF'>CHF - Franc Thụy Sĩ</option></select></div>"
                      "<div style='margin-bottom:8px'><label>Ngoại tệ 2:</label><select class='select-box' id='cur2'><option value='EUR'>EUR - Euro</option><option value='USD'>USD - Đô la Mỹ</option><option value='JPY'>JPY - Yên Nhật</option><option value='GBP'>GBP - Bảng Anh</option><option value='AUD'>AUD - Đô la Úc</option><option value='SGD'>SGD - Đô la Singapore</option><option value='CNY'>CNY - Nhân dân tệ</option><option value='KRW'>KRW - Won Hàn Quốc</option><option value='CAD'>CAD - Đô la Canada</option><option value='CHF'>CHF - Franc Thụy Sĩ</option></select></div>"
